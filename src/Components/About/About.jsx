    ...
    <>
      <div id="About" className="mt-25 flex flex-cols flex-wrap items-center justify-around mx-auto p-25 text-gray-900 dark:text-white pb-0">
        ...
        <p className="mb-50 mt-20 text-lg font-normal text-gray-500 lg:text-xl xl:px-48 dark:text-gray-400">
          ...
          <a href="yaghya_resume1.pdf" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-10" target="_blank">
            Get My Resume
