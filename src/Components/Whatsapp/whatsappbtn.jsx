...
export default function WhatsAppFloat() {
    ...
    const handleClick = () => {
        window.open('https://wa.me/916262873483', '_blank');
    };
    ...
    return (
        <>
            ...
            <button
                onClick={handleClick}
                className={`fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center group ${
